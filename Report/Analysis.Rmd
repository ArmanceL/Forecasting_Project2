...
Therefore, we are going to us the US data to see the correlation with the price of Corn and also the production of beef. 
...
```
Through this graph, we can see the linear link between the variables.

## Merging the Production VS Price
...
summary(mod3)
```
But significant when it is regressed on DATE: According to the regression, each year, the price would rise of 5.61 UNIT OF BEEF.
